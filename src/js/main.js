...
export async function initializeApp() {
    try {
        ...
        const chartPromises = [
            ...
            loadChartData('population-development-municipalities-chart', 'https://data.ssb.no/api/v0/dataset/1108.json?lang=en', 'Population Development Municipalities'),
            ...
            loadChartData('households-by-type-municipalities-chart', 'https://data.ssb.no/api/v0/dataset/1070.json?lang=en', 'Households by Type Municipalities', 'bar'),
            loadChartData('population-by-age-counties-chart', 'https://data.ssb.no/api/v0/dataset/1076.json?lang=en', 'Population by Age Counties', 'bar'),
            loadChartData('population-by-gender-age-municipalities-chart', 'https://data.ssb.no/api/v0/dataset/1078.json?lang=en', 'Population by Gender Age Municipalities', 'bar'),
            loadChartData('population-by-age-municipalities-chart', 'https://data.ssb.no/api/v0/dataset/1080.json?lang=en', 'Population by Age Municipalities', 'bar'),
            ...
            loadChartData('population-development-counties-chart', 'https://data.ssb.no/api/v0/dataset/1102.json?lang=en', 'Population Development Counties'),
            ...
            loadChartData('new-detached-house-prices-regions-chart', 'https://data.ssb.no/api/v0/dataset/25138.json?lang=en', 'New Detached House Prices Regions'),
            ...
            loadChartData('household-income-municipalities-chart', 'https://data.ssb.no/api/v0/dataset/49678.json?lang=en', 'Household Income Municipalities'),
            ...
            loadChartData('tax-returns-districts-chart', 'https://data.ssb.no/api/v0/dataset/49619.json?lang=en', 'Tax Returns Districts'),
            ...
            loadChartData('immigrants-by-county-chart', 'https://data.ssb.no/api/v0/dataset/96304.json?lang=en', 'Immigrants by County', 'bar'),
            ...
            loadChartData('population-municipalities-timeline-chart', 'https://data.ssb.no/api/v0/dataset/26975.json?lang=en', 'Population Municipalities Timeline'),
            ...
            loadChartData('population-changes-municipalities-chart', 'https://data.ssb.no/api/v0/dataset/49577.json?lang=en', 'Population Changes Municipalities'),
            loadChartData('population-changes-counties-chart', 'https://data.ssb.no/api/v0/dataset/49623.json?lang=en', 'Population Changes Counties'),
            ...
            loadChartData('first-hand-price-index-subgroups-chart', 'https://data.ssb.no/api/v0/dataset/82647.json?lang=en', 'First Hand Price Index Subgroups'),
            loadChartData('cpi-delivery-sector-annual-chart', 'https://data.ssb.no/api/v0/dataset/95134.json?lang=en', 'CPI Delivery Sector Annual'),
            ...
            loadChartData('education-level-counties-chart', 'https://data.ssb.no/api/v0/dataset/85452.json?lang=en', 'Education Level Counties', 'bar'),
            loadChartData('household-income-counties-chart', 'https://data.ssb.no/api/v0/dataset/97611.json?lang=en', 'Household Income Counties'),
            loadChartData('oil-gas-industry-turnover-sn2007-chart', 'https://data.ssb.no/api/v0/dataset/124363.json?lang=en', 'Oil Gas Industry Turnover SN2007'),
            loadChartData('household-income-districts-chart', 'https://data.ssb.no/api/v0/dataset/56928.json?lang=en', 'Household Income Districts'),
            ...
            loadChartData('economic-forecasts-selected-chart', 'https://data.ssb.no/api/v0/dataset/934516.json?lang=en', 'Economic Forecasts Selected'),
            loadChartData('producer-price-index-totals-recent-chart', 'https://data.ssb.no/api/v0/dataset/372129.json?lang=en', 'Producer Price Index Totals Recent'),
            loadChartData('production-index-industry-recent-chart', 'https://data.ssb.no/api/v0/dataset/372131.json?lang=en', 'Production Index Industry Recent'),
            loadChartData('producer-price-index-subgroups-detailed-chart', 'https://data.ssb.no/api/v0/dataset/741154.json?lang=en', 'Producer Price Index Subgroups Detailed'),
